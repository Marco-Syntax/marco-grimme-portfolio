  ...
  return (
    ...
    >
          ...
          <div className="absolute top-3 left-3 flex items-center gap-1.5">
            ...
            <span
              ...
              style={{
                ...
                WebkitBackdropFilter: "blur(8px)", // required for Safari
              }}
            >
              {project.category}
            </span>
      ...
      <div className="p-5 md:p-6 flex-1 relative">
        ...
        {/* Name */}
        <h3 className="text-lg md:text-xl font-[700] text-[#f0ede6] tracking-tight mb-1.5">
          {project.name}
        </h3>
        ...
        {/* Description */}
        <p className="text-sm text-[rgba(240,237,230,0.42)] leading-relaxed mb-5">
          {project.description}
        </p>
      ...
      {project.link && (
        ...
        >
          <span className="text-[10px] font-mono text-[rgba(240,237,230,0.2)] uppercase tracking-widest">
      ...
      <div className="max-w-[1400px] mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            <p className="text-base text-[rgba(240,237,230,0.38)] max-w-md leading-relaxed mb-1">
        ...
        >
          <motion.article
            ...
            style={{
              ...
              background: `linear-gradient(135deg, ${featured.accent}07 0%, rgba(15,14,12,0) 55%)`,
            }}
            whileHover={{
          ...
          >
            ...
            <div
              ...
              style={{
                background: `linear-gradient(90deg, transparent, ${featured.accent}, transparent)`,
              }}
            />
            {/* Subtle radial bg — GPU promoted to avoid per-scroll repaint on Safari */}
            <div
                  ...
                  {featured.image && (
                    ...
                    >
                      ...
                      <div
                        className="absolute inset-0"
                        style={{
                          background: `linear-gradient(135deg, ${featured.accent}12 0%, transparent 40%)`,
                        }}
                      />
                      <div
                        className="absolute inset-0"
                        style={{
                          background:
                            "linear-gradient(to bottom, transparent 55%, rgba(15,14,12,0.75) 100%)",
                        }}
                      />
                      {/* Border glow */}
                      <div
                        ...
                        style={{
                          boxShadow: `inset 0 0 0 1px ${featured.accent}25`,
                        }}
                      />
                    </motion.div>
                  )}
        ...
        <SectionLabel
          label="Apps"
          sub="Native und Cross-Platform – klar, performant, stabil."
          accent="#54C5F8"
        />
        <motion.div
        ...
        <SectionLabel
          ...
          sub="Moderne Plattformen – skalierbar, sauber umgesetzt."
          accent="#34D399"
        />
        <motion.div
